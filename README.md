...
# For text files with specific encoding, you can specify the encoding
omnifact-cli upload-document --space-id YOUR_SPACE_ID --file /path/to/your/document.txt --encoding windows-1252
```
